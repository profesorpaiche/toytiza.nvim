...
theme.loadEditor = function()
    ...
    local editor = {
        ...
        Normal = { fg = c.foreground, bg = c.none }, -- normal text
        NormalNC = { fg = c.foreground, bg = c.none }, -- normal text in non-current windows
        NormalSB = { fg = c.black_4, bg = c.none }, -- normal text in sidebar
        NormalFloat = { fg = c.foreground, bg = c.blackboard }, -- Normal text in floating windows.
...
theme.loadTreeSitter = function()
    local treesitter = {
        ...
        ["@type.builtin"] = { fg = c.purple_1, style = "bold" },

        --- Punctuation
        -- ["@punctuation.delimiter"] = { fg = c.red_3 }, -- For delimiters ie: `.`
        ...
        -- NOTE: This seems to be for comments
...
theme.loadPlugins = function()
    local plugins = {
        ...
        BufferCurrent = { bg = c.blackboard, fg = c.foreground },
        ...
        -- TelescopePromptTitle = { fg = c.yellow_3 },
        ...
        --- Border
        NotifyERRORBorder = { fg = c.red_1, bg = c.none },
        NotifyWARNBorder = { fg = c.orange_1, bg = c.none },
        NotifyINFOBorder = { fg = c.blue_1, bg = c.none },
        NotifyDEBUGBorder = { fg = c.yellow_1, bg = c.none },
        NotifyTRACEBorder = { fg = c.purple_1, bg = c.none },
        --- Icons
        NotifyERRORIcon = { fg = c.red_3 },
        NotifyWARNIcon = { fg = c.orange_3 },
        NotifyINFOIcon = { fg = c.blue_3 },
        NotifyDEBUGIcon = { fg = c.yellow_3 },
        NotifyTRACEIcon = { fg = c.purple_3 },
        --- Title
        NotifyERRORTitle = { fg = c.red_3 },
        NotifyWARNTitle = { fg = c.orange_3 },
        NotifyINFOTitle = { fg = c.blue_3 },
        NotifyDEBUGTitle = { fg = c.yellow_3 },
        NotifyTRACETitle = { fg = c.purple_3 },
        --- Body
